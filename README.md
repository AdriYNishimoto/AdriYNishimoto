...
Sou Adriano Nishimoto, Desenvolvedor FullStack focado em criar soluções robustas e escaláveis. Atuo no desenvolvimento de APIs, arquitetura de sistemas e otimização de performance.

Recentemente, venho ampliando minhas habilidades com **Node.js** e uso de **IA aplicada ao desenvolvimento**, incluindo ferramentas como Claude Code para acelerar entregas e aumentar produtividade.
